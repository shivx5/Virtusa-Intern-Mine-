...
function editTheme(index,event)
{
  ...
  //    <div className='display-adminorder-items'>
  //  <h3 className='adminh3' style={{textAlign:"center"}} onClick={(event)=>
  //   {
  ...
  //                   <h5> Name   :{items.themeName }</h5>
  //                   <p> 💲{items.themePrice}</p>
  //                   <p> Details :{items.themeDetails}</p>
  //                   <span onClick={()=>{setEditbutton(!editbutton);setIndex(items.themeId)}}>📝</span><span onClick={()=>deleteGift(items.themeId)}>❌</span>
  //                   </div>
  //                   </div>
  //                   )
  //        })}
  ...
  //  </div>
  //    </div>
  //  {addbuttton && <><div className='overlay-styles' onClick={()=>setAddbutton(!addbuttton)}></div><div className='addingdivision'>
   
  //      <div style={{marginLeft:"20%"}}>
  //      <h2 style={{marginLeft:"25%"}}>  New Theme  </h2>

  //      <input className='allforminputs' placeholder='enter a theme name' id='enterThemeName' name='themeName' onChange={handlegiftDetails}></input>
  //      <input className='allforminputs' placeholder='enter a theme price' id='enterThemePrice' name='themePrice' onChange={handlegiftDetails}></input>
  //      <input className='allforminputs' placeholder='enter a theme description' id='enterThemedescription' name='themeDetails' onChange={handlegiftDetails}></input>
  //      </div>
       
  //      <div style={{marginLeft:"20%"}} className='adddbuttondiv'><button id='add'style={{backgroundColor:"rgb(111, 0, 70)"}} className='admingiftbutton' onClick={()=>{addGift();setAddbutton(!addbuttton)}} >Add</button></div>
       
  //   </div></>
  //   }
  //    {editbutton && <><div className='overlay-styles' onClick={()=>setEditbutton(!editbutton)}></div><div className='addingdivision'>
  //   <div>
  //   <h2 style={{marginLeft:"25%"}}>Update Theme  </h2>

  //      <input className='allforminputs' placeholder='enter a theme name'  id='editThemeName'name='themeName' onChange={handleeditgiftDetails}></input>
  //      <input className='allforminputs' placeholder='enter a theme price'  id='editThemePrice'  name='themePrice' onChange={handleeditgiftDetails}></input>
  //      <input className='allforminputs' placeholder='enter a theme description'  id='editThemedescription'name='themeDetails' onChange={handleeditgiftDetails}></input>
  //      </div>
  //      <div style={{marginLeft:"20%"}} className='adddbuttondiv'><button style={{backgroundColor:"rgb(111, 0, 70)"}} id='update' className='admingiftbutton' onClick={()=>{editGift(index);console.log(index);setEditbutton(!editbutton)}}>Update</button></div>
